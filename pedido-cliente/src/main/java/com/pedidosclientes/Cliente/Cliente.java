...
public class Cliente 
{
	...
	// Acá se analiza si la compra ya cumplio o no las 12h. //
	public String tiempo(String price, String day, String month, String hour, String minute)
	{
		...
		{	
			...
			{
				vPenalidad = 0; 
				mensaje =" el día " + dayBuy + " a las " + hourBuy + ":" + minuteBuy + " " + " hizo una compra con un total de $" 
				+ priceBuy + ".\n" + "La devolución no tiene penalidad\nTotal a pagar $" + vPenalidad +"";
			}
			else 
			{
				vPenalidad = (priceBuy * 10)/100;
				mensaje =" el día " + dayBuy + " a las " + hourBuy + ":" + minuteBuy + " " + " hizo una compra con un total de $" + 
							priceBuy + ".\n" + "La devolución presenta una penalidad de $" + vPenalidad +" a pagar.";
			}
		}
		else
		{
			mensaje = "Cancelación no aprobada";
		}
